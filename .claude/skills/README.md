...
本目录包含 Codex + Claude Code MCP 协作中使用的自定义技能。
...
- 与 Codex 的 `/init` 命令互补（`/init` 改进 `claude.md`，此技能生成 `claude-template.md`）
...
**何时使用**：执行 `codex-workflow-largebase.md` 中的结构化扫描
...
- `../workflows/codex-workflow-largebase.md` — 大型库工作流（使用 largebase-structured-scan 技能）
- `../workflows/codex-workflow-constants.md` — 全局约束（Superpowers 调用规范）
- `../README.md` — .claude 目录完整指南
- `../../.codex/path-migration-map.md` — 迁移指南
