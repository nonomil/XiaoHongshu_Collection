...
- [x] 定义 `InboxProvider` 接口（pull({ since }) -> { items, nextModified }）
...
## Phase 5｜测试
- [x] InboxStore 单元测试
- [x] PushbulletProvider 单元测试（mock API）
- [x] API E2E：`/api/inbox/sync`

## Phase 6｜文档与说明
- [x] 更新使用说明（如何获取 Token / 如何同步）
- [x] 记录扩展入口的“可接入其他来源”规范
