...
if not defined WEB_PORT set "WEB_PORT=7861"
if not defined FALLBACK_WEB_PORT set "FALLBACK_WEB_PORT=7862"
...
echo [信息] 正在启动本地 Web 工作台...
echo [信息] 启动地址：http://%WEB_HOST%:%WEB_PORT%/
echo [信息] 如需停止服务，关闭当前窗口即可。
echo.

"%PYTHON_EXE%" -m video_summary_cli.cli web --host %WEB_HOST% --port %WEB_PORT%
